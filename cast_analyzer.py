...
class Analyzer(object):
    ...
    def print_analysis(self):
        ...
        self.register_col_header("[4]Throughput-lifetime_product", 7, lambda x : x.tot.throughput)
    ...
    def print_cols(self, only_valid = True):
        for ps_str in self.full:
            ...
            self.print_by_case(tasks, "[4]Throughput-lifetime_product", round_point=3, sum_opt = lambda x : x.tot.w_sum)
